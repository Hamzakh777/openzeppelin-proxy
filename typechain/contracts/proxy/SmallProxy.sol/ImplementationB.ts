...
export interface ImplementationBInterface extends utils.Interface {
  functions: {
...
export interface ImplementationB extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImplementationBInterface;
