...
export interface ImplementationAInterface extends utils.Interface {
  functions: {
...
export interface ImplementationA extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImplementationAInterface;
